    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: 'Entidad', value: 'calories', align:'center' },
          { text: 'Inicio', value: 'fat', align:'center' },
          { text: 'Contacto', value: 'carbs', align:'center' },
          { text: 'Línea Acción', value: 'protein', align:'center' },
